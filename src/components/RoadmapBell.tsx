        ...
        {open ? (
          <div className="fixed inset-0 z-[60]">
            ...
            <motion.div
              ...
              className="absolute left-1/2 w-[calc(100%-2rem)] max-w-2xl -translate-x-1/2 rounded-3xl border border-zinc-200 bg-white p-5 shadow-2xl dark:border-zinc-800 dark:bg-zinc-950"
              style={{
                bottom: 'calc(1.5rem + env(safe-area-inset-bottom))',
              }}
              role="dialog"
