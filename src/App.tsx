...
useEffect(() => {
  ...
  async function onCreateWallet() {
    // “Create Wallet” for Base Account / Smart Wallet is effectively the first wallet connection
    // inside Mini App hosts. We keep this separate so the UI can show a clearly labeled CTA.
    try {
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2 sm:flex-row">
	                  <Button
	                    ...
	                    disabled={!miniLoaded || Boolean(identity.address)}
	                    className="w-full sm:w-auto"
	                  >
	                    <Wallet className="h-4 w-4" />
	                    {identity.address ? 'Wallet connected' : 'Create Wallet'}
	                  </Button>
