...
export default function App() {
  ...
  const canGenerate = useMemo(() => (credits ?? 0) > 0 && !generating && miniLoaded && isInMiniApp, [credits, generating, miniLoaded, isInMiniApp])
  ...
  async function onGenerate(isRegen = false) {
    ...
    if (!identity.fid && !identity.address) {
    ...
    try {
      ...
      const out = await apiGenerate(identity, extra)
      setResult(out.text)
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="bg-grid min-h-screen">
        <div className="mx-auto max-w-2xl px-4 py-10">
          ...
          <Card className="mt-6">
            <CardHeader>
              <div className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Prompt</div>
              <div className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">Add extra flavor like “bullish”, “meme style”, “builder mode”…</div>
            </CardHeader>
            <CardContent>
              <Textarea
                value={prompt}
                ...
                rows={4}
                placeholder="e.g. make it bullish but not shilly. keep it clever."
              />
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex gap-2">
                  <Button
                    ...
                    disabled={!canGenerate || (credits ?? 0) < 1}
