...
// Using the app contract address by default.
...
export default function App() {
  ...
  async function onGetCredit() {
    ...
    try {
      ...
      // Ensure the user has a tiny amount of ETH for gas on Base
      ...
      if (balance < minGasWei) {
        throw new Error('Insufficient gas on Base. Add a small amount of ETH on Base (e.g. 0.00005 ETH) and retry.')
      }
