...
import { adjustCredits, getOrCreateUser, incrementMetric, recordSpend } from './_lib/store.js'
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    // Leaderboard: credits spent (only on success)
    await recordSpend(userId, 1)
