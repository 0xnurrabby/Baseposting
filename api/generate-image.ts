...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    // Prefer durable public blob storage when configured. This was the previously working
    // cross-device preview path. Fall back to Redis-backed /api/image only when Blob is unavailable.
